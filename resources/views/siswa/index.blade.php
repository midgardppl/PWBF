    ...
    <div class="navbar-menu-wrapper flex-grow d-flex navbar-light align-items-stretch">
      ...
      <ul class="navbar-nav navbar-nav-right">
        ...
        <li class="nav-item dropdown d-none d-lg-block">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" data-toggle="modal" data-target="#modalTambahGuru">
              <div class="preview-thumbnail">
              </div>
              <div class="preview-item-content">
                <p class="preview-subject ellipsis mb-1">Guru</p>
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" data-toggle="modal" data-target="#modalTambahSiswa">
              <div class="preview-thumbnail">
              </div>
              <div class="preview-item-content">
                <p class="preview-subject ellipsis mb-1">Siswa</p>
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" data-toggle="modal" data-target="#modalTambahMapel">
              <div class="preview-thumbnail">
              </div>
              <div class="preview-item-content">
                <p class="preview-subject ellipsis mb-1">Mapel</p>
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" data-toggle="modal" data-target="#modalTambahKelas">
              <div class="preview-thumbnail">
              </div>
              <div class="preview-item-content">
                <p class="preview-subject ellipsis mb-1">Kelas</p>
...
<body>
    ...
    <div class="cnt" style="margin-top: 50px">
      <div class="row gutters-20">
        ...
        <h1 class="text-center mb-5" style="margin-top:30px">Data Siswa</h1>
        ...
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($s-> statusSiswa==0)
                            <td>Tidak Aktif</td>
                            @elseif ($s-> statusSiswa==1)
                                <td>Aktif</td>
                            @endif
                        <td>

                            @foreach ($s->kelas as $item)
                                {{$item -> namaKelas}}
                                <br>
                            ...
                            <td style="display: flex;">
                                <a style="margin: 5px " data-toggle="modal" data-target="#updateSiswa{{$s->id}}" class="btn btn-success btn-sm">Edit</a>
