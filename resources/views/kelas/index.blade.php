...
<body>
    ...
    <div class="cnt" style="margin-top: 50px">
      ...
      <h1 class="text-center mb-5" style="margin-top:30px">Kelas</h1>
                    ...
                    <tr>
                        ...
                        <td>{{$m -> namaKelas}}</td>
                            <td style="display: flex;">
                                <a style="margin: 5px " data-toggle="modal" data-target="#updateKelas{{$m->id}}" class="btn btn-success btn-sm">Edit</a>
                                <form action="{{route ('kelas.destroy', $m->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
