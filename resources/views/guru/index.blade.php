    ...
    <div class="navbar-menu-wrapper flex-grow d-flex navbar-light align-items-stretch">
      ...
      <ul class="navbar-nav navbar-nav-right">
        ...
        <li class="nav-item dropdown d-none d-lg-block">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" href="" data-toggle="modal" data-target="#modalTambahGuru">
              <div class="preview-thumbnail">
              </div>
              <div class="preview-item-content">
                <p class="preview-subject ellipsis mb-1">Guru</p>
...
<body>
    ...
    <div class="cnt" style="margin-top: 50px">
      <div class="row gutters-20">
        ...
        <h1 class="text-center mb-5" style="margin-top:30px">Data Guru</h1>
                    ...
                    @foreach ($guru as $g)
                        <tr>
                            ...
                            <td style="display: flex;">
                                <a style="margin: 5px " data-toggle="modal" data-target="#updateGuru{{$g->id}}" class="btn btn-success btn-sm">Edit</a>
